<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mostrarProducto.aspx.cs" Inherits="Mercado.mostrarProducto" %>
...
<body style="background:#e8e7e7">
  ...
  <div class="panel-body">
     <asp:TextBox ID="youtube" CssClass="form-control form" runat="server" Style="width: 100%; "></asp:TextBox></div>
        ...
        <div class="col-xs-12"><asp:Button ID="botonActivacion" style="width: 80%; margin-left: 210px;margin-top: -120px;" class="btn btn-primary" runat="server" Text="Activación" Visible="false" /></div>
