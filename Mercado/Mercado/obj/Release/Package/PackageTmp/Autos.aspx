<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Autos.aspx.cs" Inherits="Mercado.Autos" %>
        ...
        <div class="row grande" style=" width:106%; height:90%; margin-right:0px">
            ...
            <div class="col-xs-4" style="height:40px">
                <div class="row">
                    ...
                    <div class="col-xs-6 autos"><asp:ImageButton ID="BotonImagenAuto" runat="server" ImageUrl="img/autos.png" /></div>
                    <div class="col-xs-6 casas"><asp:ImageButton ID="BotonImagenCasaM" runat="server" ImageUrl="img/casasM.png" /></div>
                       
                </div>
                <div class="row">

                    <div class="col-xs-6 servicios"><asp:ImageButton ID="BotonImagenProductoM" runat="server" ImageUrl="img/productosM.png" /></div>
                    <div class="col-xs-6 productos"><asp:ImageButton ID="BotonImagenServiciosM" runat="server" ImageUrl="img/serviciosM.png"  /></div>
            ...
            <div class="col-xs-4" style="height:40px">
                <div class ="row">
                    ...
                    <div class="col-xs-12"><asp:DropDownList ID="Categoria5" AutoPostBack="true" Visible="false" runat="server" Height="32px" Width="255px" style="margin-top:25px; margin-left: 20px"></asp:DropDownList></div>
                    <div class="col-xs-12"><asp:DropDownList ID="Categoria6" AutoPostBack="true" Visible="false" runat="server" Height="32px" Width="255px" style="margin-top:25px; margin-left: 20px"></asp:DropDownList></div>
                </div>
            </div>
