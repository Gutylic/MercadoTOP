    ...
    <div class="col-xs-10" style="background-color:white; border: solid 1px silver; border-radius: 5px; top: 0px; left: 0px; height: 324px; width:80%">
        ...
        <table style="width: 100%; margin-left:30px; height: 257px;">
            ...
            <tr>
                ...
                <td><asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">No sé mi clave</asp:LinkButton></td>
            </tr>
            <tr>
                <td > </td>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="Button1" CssClass="btn btn-primary" Height="37px" runat="server" Text="Ingresar" Font-Size="16px" style="margin-top:5px" Font-Bold="true" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <div style="font-size:13px; margin-top:-10px">¿Aún no tienes una cuenta? &nbsp;&nbsp;&nbsp;<asp:LinkButton ID="LinkButton2" runat="server">Regístrate</asp:LinkButton></div>
