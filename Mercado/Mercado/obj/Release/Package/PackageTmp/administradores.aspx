<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="administradores.aspx.cs" Inherits="Mercado.administradores" %>
...
">Ingresar como administrador</h3>
  ...
  <div class="form-group" style="margin-top:10px; padding-bottom: 30px; ">
    ...
    <div class="col-sm-9">
      <input class="form-control" id="inputEmail13" placeholder="Ingrese su administrador">
    </div>
  </div>
...
<div class="form-group" style="margin-top:10px; padding-bottom: 30px;">
    ...
    <div class="col-sm-9">
      <input class="form-control" id="inputEmail23" placeholder="Ingrese su usuario">
    </div>
  </div>
