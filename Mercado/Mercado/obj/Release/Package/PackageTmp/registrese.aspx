...
<body style="background-color:#e8e7e7;">
    ...
    <div class="col-xs-10" style="background-color:white; border: solid 1px silver; border-radius: 5px; top: 0px; left: 0px; height: 550px; width: 80%">
        ...
        <table style="width: 100%; margin-left:20px; height: 536px;">
            ...
            <tr>
                ...
                <td style="padding-left:10px" class="auto-style2"><asp:TextBox CssClass="form-control" ID="TextBox12" Width="90%" Height="40px" runat="server"></asp:TextBox></td>
                <td></td>
            </tr>
            <tr>
                ...
                <td style="padding-left:10px" class="auto-style2"><asp:TextBox CssClass="form-control" ID="TextBox14" Width="90%" Height="40px" runat="server"></asp:TextBox></td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding-left:10px" class="auto-style2"><asp:TextBox CssClass="form-control" ID="TextBox53" Width="70%" Height="40px" runat="server"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="Button1" CssClass="btn btn-primary" Height="37px" runat="server" Text="Registrarme" Font-Size="16px" style="margin-top:5px" Font-Bold="true" />
                </td>
                <td></td>
            </tr>
            <tr>
                <td></td>
                <td style="padding-top:10px; font-size:10px">Al registrarme, declaro que soy mayor de edad y acepto los <asp:LinkButton ID="LinkButton1" runat="server">Términos y condiciones</asp:LinkButton> y las <asp:LinkButton ID="LinkButton3" runat="server">Póliticas de privacidad</asp:LinkButton> de MercadoTop</td>
                <td></td>
            </tr>
        </table>
