    ...
    <div class="col-xs-10" style="background-color:white; border: solid 1px silver; border-radius: 5px; top: 0px; left: 0px; height: 324px; width:80%">
        ...
        <table style="width: 100%; margin-left:30px; height: 257px;">
            ...
            <tr>
                ...
                <td><asp:Button ID="botonRegistrate" runat="server" style="font-size:16px" CssClass="btn btn-primary" Height="37px" Text="Regístrate y publica" OnClick="botonRegistrate_Click" /></td>
            </tr>
            <tr>
                <td > </td>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="botonIngresar" CssClass="btn btn-primary" Height="37px" runat="server" Text="Publicar" Font-Size="16px" style="margin-top:5px" Font-Bold="true" OnClick="botonIngresar_Click" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <div style="font-size:13px; margin-top:-10px; z-index:999"><asp:LinkButton ID="Nosemiclave" runat="server" OnClick="Nosemiclave_Click">No sé mi clave</asp:LinkButton></div>
