<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paginaPrincipal.aspx.cs" Inherits="Mercado.paginaPrincipal" EnableEventValidation="false" %>
            ...
            <table style="width: 100%;">
                <tr>
                  ...
                  <a href="#" data-toggle="popover" id="todo" data-placement="bottom" runat="server" data-content="<a href='panelUsuario.aspx'>Panel de Ventas </a>"> <asp:Label ID="etiquetaNombre" runat="server" style="color:black" Text="Label"></asp:Label>
                    ...
                    |                    
                    <asp:LinkButton ID="LinkVender" runat="server" style="color:black" OnClick="LinkVender_Click" >&nbsp;Vender</asp:LinkButton>
                    |
        ...
        <asp:DataList ID="DataList_Productos" runat="server" OnItemCommand="Identificador"  CellPadding="4" ForeColor="#333333" style="margin-top:54px;" Height="249px" Width="100%">   
            ...
            <ItemTemplate>
                <div class="row">
                        ...
                        <div class="col-xs-8 producto"   style="height:80px; padding-top: 25px;"><asp:Label ID="Titulo_Producto" runat="server" style="font-size:15px; 
    font-weight:bolder; text-align:left;" Text='<%# string.Concat(Eval("tituloProducto"))%>'></asp:Label></div>                        
                    
                       <div class="col-xs-2 precio" style="height:80px; padding-top: 25px;"><asp:Label ID="Precio_Producto" style="font-size:15px; 
