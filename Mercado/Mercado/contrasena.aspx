    ...
    <section style="padding: 100px">
        ...
        <table style="width: 100%; margin-left:10px; height: 93px;">
            <tr>
                ...
                <td style="padding-left:10px" class="auto-style4" ><asp:TextBox CssClass="form-control" ID="nickUsuario" Width="30%" Height="30px" runat="server"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="botonContrasena" CssClass="btn btn-primary" Height="37px" runat="server" Text="Continuar" Font-Size="16px" style="margin-top:5px" Font-Bold="true" OnClick="botonContrasena_Click" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
